        ...
        <head>
            ...
            <style>
                * {{
                ...
                .container {{
                    max-width: { '100%' if device == 'mobile' else '1400px' };
                    margin: 0 auto;
                    padding: { '10px' if device == 'mobile' else '20px' };
                }}
                
                /* Header Styles */
                .header {{
                    background: linear-gradient(135deg, var(--accent), var(--accent-hover));
                    padding: { '15px 10px' if device == 'mobile' else '25px 20px' };
                ...
                .logo {{
                    font-size: { '20px' if device == 'mobile' else '28px' };
                    font-weight: 800;
                    display: flex;
                    align-items: center;
                    gap: 10px;
                ...
                .logo-icon {{
                    font-size: { '24px' if device == 'mobile' else '32px' };
                ...
                .timer {{
                    ...
                    border-radius: 20px;
                    font-weight: 700;
                    font-size: { '14px' if device == 'mobile' else '16px' };
                ...
                .control-grid {{
                    display: grid;
                    grid-template-columns: {'1fr' if device == 'mobile' else 'repeat(auto-fit, minmax(200px, 1fr))'};
                    gap: 15px;
                    margin-bottom: 20px;
                }}
                ...
                .info-grid {{
                    display: grid;
                    grid-template-columns: {'repeat(2, 1fr)' if device == 'mobile' : 'repeat(4, 1fr)'};
                    gap: 15px;
                }}
                ...
                /* Main Content */
                .main-content {{
                    display: {'block' if device == 'mobile' else 'flex'};
                    gap: 25px;
                }}
                ...
                .questions-section {{
                    ...
                    box-shadow: 0 8px 32px var(--shadow);
                    border: 1px solid var(--border);
                    {'margin-bottom: 20px;' if device == 'mobile' else ''}
                }}
                
                .question-nav {{
                    flex: {'1' if device == 'mobile' else '0 0 300px'};
                    background: var(--bg-card);
                    border-radius: 20px;
                    padding: 20px;
                    box-shadow: 0 8px 32px var(--shadow);
                    border: 1px solid var(--border);
                    {'order: -1; margin-bottom: 20px;' if device == 'mobile' else ''}
                }}
                ...
                .question-grid {{
                    display: grid;
                    grid-template-columns: {'repeat(5, 1fr)' if device == 'mobile' else 'repeat(6, 1fr)'};
                    gap: 10px;
                    margin-bottom: 20px;
                }}
                
                .question-btn {{
                    width: {'35px' if device == 'mobile' else '40px'};
                    height: {'35px' if device == 'mobile' else '40px'};
                    border: 2px solid var(--border);
                    border-radius: 10px;
                    display: flex;
                    align-items: center;
                ...
                .actions {{
                    display: flex;
                    justify-content: {'space-between' if device == 'desktop' else 'center'};
                    flex-wrap: wrap;
                    gap: 10px;
                    margin-top: 30px;
                    padding-top: 20px;
                ...
                .btn {{
                    ...
                    align-items: center;
                    gap: 8px;
                    {'flex: 1; min-width: 120px; justify-content: center;' if device == 'mobile' else ''}
                }}
                ...
                .results-grid {{
                    display: grid;
                    grid-template-columns: {'1fr 1fr' if device == 'mobile' else 'repeat(4, 1fr)'};
                    gap: 20px;
                    margin: 30px 0;
                }}
...
class TelegramTestBot:
    ...
    async def start_bot(self):
        ...
        await self.start_pyrogram_bot()
        await self.start_telegram_bot()
    
    async def start_pyrogram_bot(self):
        """Start Pyrogram bot"""
        app = Client(
            "test_bot",
        ...
        async def pyro_start(client, message: Message):
            keyboard = [
            ...
            await message.reply_text(
                "🚀 **Premium Test Series Bot**\\n\\n"
                "Send me a JSON file to generate beautiful test series!",
                reply_markup=reply_markup
            )
        
        @app.on_message(filters.document)
        async def handle_pyro_document(client, message: Message):
        ...
        async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
            ...
            **Commands:**
            ...
            keyboard = [
                ...
                [InlineKeyboardButton("🎨 Preview Themes", callback_data="themes")],
    ...
    async def process_document(self, message: Message):
        """Process document for Pyrogram"""
        try:
            ...
            # Generate HTML with default dark theme and desktop view
            ...
            await message.reply_document(
                ...
                **Instructions:**
                ...
                3. Choose your preferred theme and device view
                4. Start your test!

                🎯 **Total Questions:** {len(json_data['data'])}
